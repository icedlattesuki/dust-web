<template>
    <NewNavBar></NewNavBar>
    <div class="grid grid-rows-6 grid-flow-col mx-auto max-w-screen-2xl sm:px-6 lg:px-16">
        <div class="row-span-6">
            <div class="w-60 h-full shadow-md bg-white  mt-10">
                <ul class="relative">
                    <li class="relative">
                        <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" href="#!">
                            账户设置
                        </a>
                     </li>
                    <li class="relative">
                ...
                <div>
                    <div class="profile-item">
                        ...
                        <div class="profile-item">
                            ...
                            <a-input v-model:value="username" v-if="editUsername"><a-button type="link" @click="enableEditUsername"><edit-outlined /></a-button></a-input>
                            <p v-else>{{username}}<a-button type="link" @click="enableEditUsername"><edit-outlined /></a-button></p>
                        </div>
                        <div class="profile-item">
